...
const faqs = [
  { q: 'Bagaimana cara login 18TOTO?', a: 'Kunjungi halaman login resmi di situs resmi 18TOTO, masukkan username dan password, lalu klik Login.' },
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>18TOTO | Akses Cepat & Aman: Petualangan Tanpa Batas Dimulai</title>
        <meta name="description" content="18TOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="18TOTO | Akses Cepat & Aman: Petualangan Tanpa Batas Dimulai" />
        <meta property="og:description" content="18TOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="18TOTO | Akses Cepat & Aman: Petualangan Tanpa Batas Dimulai" />
        <meta name="twitter:description" content="18TOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
      ...
      <style jsx global>{`
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Inter',sans-serif;background:#0d0d1a;color:#e8e8e8;line-height:1.6;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .W{max-width:1240px;margin:0 auto;padding:0 20px}

        /* Top Bar */
        .topbar{background:#121228;border-bottom:1px solid rgba(0,212,255,.2);font-size:12px;padding:8px 0;color:#aaa}
        .topbar-inner{display:flex;justify-content:space-between;align-items:center}
        .topbar a{color:#00d4ff;transition:.2s}.topbar a:hover{opacity:.8}

        /* Header */
        header{background:#121228ee;backdrop-filter:blur(16px);border-bottom:1px solid rgba(0,212,255,.2);position:sticky;top:0;z-index:50}
        .hd{display:flex;align-items:center;justify-content:space-between;padding:12px 0;gap:16px}
        .logo{display:flex;align-items:center;gap:10px;font-weight:800;font-size:22px;color:#00d4ff;flex-shrink:0}
        .logo img{width:38px;height:38px;border-radius:12px;border:2px solid #00d4ff}
        .search-bar{flex:1;max-width:520px;display:flex;border:1.5px solid rgba(0,212,255,.2);border-radius:8px;overflow:hidden;background:#1a1a35}
        ...
        .search-bar button{background:#00d4ff;color:#0d0d1a;border:none;padding:0 18px;font-weight:700;cursor:pointer;font-family:inherit;font-size:13px;transition:.2s}
        .search-bar button:hover{background:#0099cc}
        ...
        .btn-p{background:#00d4ff;color:#0d0d1a}.btn-p:hover{background:#0099cc;transform:translateY(-1px)}
        .btn-o{border:1.5px solid rgba(0,212,255,.2);color:#00d4ff;background:transparent}.btn-o:hover{background:rgba(0,212,255,.12)}

        /* Category Nav */
        .catnav{background:#1a1a35;border-bottom:1px solid rgba(0,212,255,.2)}
        ...
        .catnav a:hover,.catnav a.act{color:#00d4ff;border-bottom-color:#00d4ff}

        /* Hero */
        .hero-banner{background:linear-gradient(135deg,#00d4ff,#0099cc);padding:50px 0;position:relative;overflow:hidden}
        ...
        .hero-text .btn-w{background:#fff;color:#0d0d1a;font-weight:700;padding:12px 26px;border-radius:8px;border:none;cursor:pointer;font-family:inherit;font-size:14px;transition:.2s}
        ...
        /* Stats */
        .stats{background:#121228;border-bottom:1px solid rgba(0,212,255,.2);padding:22px 0}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;text-align:center}
        .stat-item .sv{font-size:24px;font-weight:800;color:#00d4ff}
        .stat-item .sl{font-size:10px;color:#bbb;text-transform:uppercase;letter-spacing:1.5px}

        /* Sections */
        .sec{padding:50px 0}
        .sec-alt{background:#121228}
        .sec-head{text-align:center;margin-bottom:36px}
        .sec-head .label{display:inline-block;background:rgba(0,212,255,.12);color:#00d4ff;padding:5px 16px;border-radius:6px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;margin-bottom:10px;border:1px solid rgba(0,212,255,.2)}
        ...
        .art-content h3{font-size:20px;font-weight:700;margin-bottom:14px;color:#00d4ff}
        ...
        .art-gallery img{border-radius:10px;border:1px solid rgba(0,212,255,.2);width:100%;height:200px;object-fit:cover}
        .art-tags{display:flex;gap:8px;flex-wrap:wrap;margin-top:12px}
        .art-tag{background:rgba(0,212,255,.12);color:#00d4ff;padding:5px 14px;border-radius:6px;font-size:11px;font-weight:600;border:1px solid rgba(0,212,255,.2)}

        /* Feature Grid */
        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}
        .feat-card{background:#1a1a35;border:1px solid rgba(0,212,255,.2);border-radius:12px;padding:24px;transition:.3s}
        .feat-card:hover{border-color:#00d4ff;transform:translateY(-4px);box-shadow:0 8px 30px rgba(0,0,0,.3)}
        .feat-card .fi-icon{width:46px;height:46px;border-radius:10px;background:rgba(0,212,255,.12);display:flex;align-items:center;justify-content:center;font-size:20px;margin-bottom:14px}
        ...
        /* CTA */
        .cta-box{background:linear-gradient(135deg,#00d4ff,#0099cc);border-radius:16px;padding:48px 32px;text-align:center;color:#fff;position:relative;overflow:hidden}
        ...
        .cta-box .btn-w{background:#fff;color:#0d0d1a;font-weight:700;padding:14px 32px;border-radius:8px;border:none;cursor:pointer;font-family:inherit;font-size:15px;transition:.2s}
        ...
        .bnr-card{border-radius:12px;overflow:hidden;border:1px solid rgba(0,212,255,.2);transition:.3s}
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,.3);border-color:#00d4ff}
        .bnr-card img{width:100%;height:auto}

        /* FAQ */
        .faq-list{max-width:720px;margin:0 auto}
        .faq-item{background:#1a1a35;border:1px solid rgba(0,212,255,.2);border-radius:10px;padding:16px 20px;margin-bottom:8px;cursor:pointer;transition:.2s}
        .faq-item:hover{border-color:#00d4ff}
        .faq-q{font-weight:600;display:flex;justify-content:space-between;align-items:center;font-size:14px;color:#ddd}
        .faq-q span{color:#00d4ff;font-size:18px;font-weight:700}
        .faq-a{margin-top:10px;color:#bbb;font-size:13px;line-height:1.7;border-top:1px solid rgba(0,212,255,.2);padding-top:10px}

        /* Footer */
        footer{background:#121228;border-top:1px solid rgba(0,212,255,.2);padding:32px 0;font-size:12px}
        .ft-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:30px;margin-bottom:20px}
        .ft-col h4{color:#00d4ff;font-size:14px;margin-bottom:12px}
        .ft-col a{display:block;color:#888;margin-bottom:6px;transition:.2s}.ft-col a:hover{color:#00d4ff}
        .ft-bottom{border-top:1px solid rgba(0,212,255,.2);padding-top:16px;text-align:center;color:#666}
        ...
        <section className="hero-banner"><div className="W">
          <div className="hero-flex">
            <div className="hero-text">
              ...
              <h1>18TOTO | Akses Cepat & Aman: Petualangan Tanpa Batas Dimulai</h1>
              <p>18TOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam.</p>
              <div className="hbtns">
        ...
        <section className="sec sec-alt" id="tentang"><div className="W">
          ...
          <div className="art-row">
            <div className="art-content">
              ...
              <p>18TOTO hadir di situs resmi 18TOTO dengan komitmen menghadirkan layanan digital terpercaya yang mengutamakan keamanan pengguna. Sebagaimana rumah sakit menjaga kesehatan pasien, 18TOTO menjaga keamanan data dan kenyamanan akses setiap pengguna. Sistem keamanan berlapis dengan enkripsi SSL 256-bit melindungi setiap informasi pribadi, sementara server berperforma tinggi memastikan loading halaman dalam hitungan detik.</p>
              <div className="art-gallery">
              ...
              <p>Platform resmi 18TOTO di situs resmi 18TOTO dirancang dengan standar keamanan tertinggi dan antarmuka yang bersih serta intuitif. Dukungan teknis profesional tersedia 24 jam sehari, 7 hari seminggu, siap membantu setiap kendala yang Anda hadapi. Dengan uptime 99,9% dan multiple link alternatif yang selalu diperbarui, 18TOTO memastikan Anda selalu dapat mengakses layanan tanpa gangguan dari lokasi manapun.</p>
